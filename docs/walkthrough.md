...
The system uses **Google Gemini Embeddings** and **PostgreSQL pgvector** to find the properties that match the *concept* of the user's dream home.

### 2. RAG Property Assistant
Every property detail page features an AI assistant. It doesn't just give generic answers; it "reads" the specific details of that property (amenities, size, neighborhood) to answer visitor questions accurately.
...
- **n8n Orchestration**: Workflows for Telegram lead capture and Google Calendar sync are ready for import in `n8n_workflows/`.
...
- **Telegram Automation**: Full setup instructions available in the [Telegram Automation Guide](file:///C:/Users/jesse/.gemini/antigravity/brain/cc117cf7-2d62-41fe-8dc9-5bb4158d3f08/telegram_automation_guide.md).
