...
sequenceDiagram
    ...
    alt invalid or expired code
        ...
        AuthController->>UserModel: db.query(models.User).filter(telegram_chat_id == "12345").all()
        activate UserModel
        ...
        Note over AuthController: user.telegram_chat_id = "12345"
...
alt invalid or expired code
    ...
    AuthController -> AuthController : user.telegram_chat_id = "12345"
